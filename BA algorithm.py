...
def barabasi_albert_graph_tri_count(n, m, seed=None):
    """Return random graph using Barabási-Albert preferential attachment model.
...
def triangle_consistancy(repeat,N,m):
    i=0
    while i < repeat:
        print(str(barabasi_albert_graph_tri_count(N,m))[1:-1])
        i+=1


def barabasi_albert_graph_degree_histogram(n, m, seed=None):
    """Return random graph using Barabási-Albert preferential attachment model.
